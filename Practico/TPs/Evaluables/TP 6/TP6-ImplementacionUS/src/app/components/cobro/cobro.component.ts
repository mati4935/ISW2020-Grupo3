...
export class CobroComponent implements OnInit {
  ...
  Confirmar()
  {
    ...
    {
      if(this.formFormaPago.invalid || this.formEFECTIVO.invalid || this.formRECEPCION.invalid)
      {
        return;
      }
    }
    ...
    {
      if(this.formFormaPago.invalid || this.formVISA.invalid || this.formRECEPCION.invalid)
      {
        return;
      }
    }
